...
/**
 * Centralized API Key Manager using Singleton pattern
...
public class ApiKeyManager {
    ...
    @Value("${app.verification.sms.api-key:#{null}}")
    private String smsApiKey;

    @Value("${google.cloud.api.key:#{null}}")
    private String googleCloudApiKey;

    @Value("${ai.agent.api.key:#{null}}")
    ...
    private void loadApiKeys() {
        ...
        setApiKey(ApiKeyType.SMS, smsApiKey);
        setApiKey(ApiKeyType.GOOGLE_CLOUD, googleCloudApiKey);
        setApiKey(ApiKeyType.AI_AGENT, aiAgentApiKey);
