...
public record ReportCreateRequest(
  ...
  public Report toEntity(User user, Category category) {
    return Report.builder()
        ...
        .latitude(location != null && location.latitude() != null ? BigDecimal.valueOf(location.latitude()) : null)
        .longitude(location != null && location.longitude() != null ? BigDecimal.valueOf(location.longitude()) : null)
