...
part of 'report_api_client.dart';
...
class _ReportApiClient implements ReportApiClient {
  _ReportApiClient(
    this._dio, {
    this.baseUrl,
    this.errorLogger,
  ...
  @override
  Future<ReportListResponse> getReports(Map<String, dynamic> queries) async {
  ...
  @override
  Future<List<ReportComment>> getReportComments(String id) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<List<ReportComment>>(Options(
      method: 'GET',
      headers: _headers,
      extra: _extra,
    )
    ...
    late List<ReportComment> _value;
    try {
      _value = _result.data!
          .map((dynamic i) => ReportComment.fromJson(i as Map<String, dynamic>))
          .toList();
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options);
      rethrow;
  ...
  Future<ReportComment> addComment(
    ...
    final _data = <String, dynamic>{};
    _data.addAll(request);
    final _options = _setStreamType<ReportComment>(Options(
      method: 'POST',
      headers: _headers,
      extra: _extra,
    )
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(_options);
    late ReportComment _value;
    try {
      _value = ReportComment.fromJson(_result.data!);
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options);
      rethrow;
    }
  ...
  @override
  Future<ImageUploadResponse> requestImageUpload(
  ...
  Future<AIAnalysisResult> analyzeImage(
    ...
    final _data = <String, dynamic>{};
    _data.addAll(request);
    final _options = _setStreamType<AIAnalysisResult>(Options(
      method: 'POST',
      headers: _headers,
      extra: _extra,
    )
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(_options);
    late AIAnalysisResult _value;
    try {
      _value = AIAnalysisResult.fromJson(_result.data!);
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options);
      rethrow;
    }
  ...
  Future<ReportStatsResponse> getReportStats() async {
    ...
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<ReportStatsResponse>(Options(
      method: 'GET',
      headers: _headers,
      extra: _extra,
    )
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(_options);
    late ReportStatsResponse _value;
    try {
      _value = ReportStatsResponse.fromJson(_result.data!);
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options);
      rethrow;
    }
  ...
  @override
  Future<ReportListResponse> getBookmarkedReports(
